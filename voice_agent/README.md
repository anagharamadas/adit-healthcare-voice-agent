...
**Demo:** [`Adit_demo_recording.mp4`](../Adit_demo_recording.mp4) — a real
...
```bash
git clone https://github.com/anagharamadas/adit-healthcare-voice-agent.git
cd adit-healthcare-voice-agent/voice_agent
