...
**Consequence for the brief:** the assignment says "call recording *or* audio reference". The stronger option is available — attach the real file, and keep a URI reference only as a last resort if recording itself fails.
