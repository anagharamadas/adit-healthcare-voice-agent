# Outbound Healthcare Voice Agent — Take-home Submission
...
| File | What it shows |
|---|---|
| [`Adit_demo_recording.mp4`](Adit_demo_recording.mp4) **(7:15)** | The main demo. A real outbound call placed from the terminal and answered on a handset, then a second call demonstrating the identity gate, with the post-call analysis and the Opik trace. |
...
1. **Watch** [`Adit_demo_recording.mp4`](Adit_demo_recording.mp4) — a real call, start to finish.
